...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', default=1e-3, type=float, help='Choose loss function')
    ...
    # training loop
    save_dir = '../results/{}/hcl'.format(dataset_name)
    ...
    if dataset_name in ['cub', 'imagenet']:
        test_epoch = 100
    ...
    for epoch in range(0, epochs + 1):
        ...
        if epoch % test_epoch == 0:
            ...
            if do_beta_anneal is True:
                torch.save(model.state_dict(), '../results/{}/hcl/{}_{}_model_{}_{}_{}_{}_{}.pth'.format(dataset_name,dataset_name,estimator,batch_size,tau_plus,beta,epoch,anneal))
            else:
                torch.save(model.state_dict(), '../results/{}/hcl/{}_{}_model_{}_{}_{}_{}.pth'.format(dataset_name,dataset_name,estimator,batch_size,tau_plus,beta,epoch))
